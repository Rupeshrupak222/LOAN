    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900/70 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-500/30 transition-all"
          >
            Prime Salaried
          </button>
          <button
            ...
            className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-amber-500/10 hover:bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-500/30 transition-all"
          >
            High FOIR
          </button>
          <button
            ...
            className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-rose-500/10 hover:bg-rose-500/20 text-rose-700 dark:text-rose-300 border border-rose-500/30 transition-all"
          >
            Subprime Score
          </button>
          <button
            ...
            className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-red-500/10 dark:bg-red-500/20 hover:bg-red-500/20 dark:hover:bg-red-500/30 text-red-700 dark:text-red-300 border border-red-500/40 transition-all"
          >
            Fraud Signal
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-4">
          <form onSubmit={handleSimulate} className="bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-xl space-y-5">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-white"
                >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-1.5 text-xs text-slate-900 dark:text-white font-mono"
                  />
                </div>
                <div>
            ...
            {/* Borrower & Employment */}
            <div className="p-3 bg-slate-50/80 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800 space-y-3">
              <span className="text-[11px] font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider block">
                Borrower Profile
              </span>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[11px] text-slate-600 dark:text-slate-400 mb-1">Age (Years)</label>
                  <input
                    type="number"
                    value={applicantAge}
                    onChange={(e) => setApplicantAge(Number(e.target.value))}
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-xs text-slate-900 dark:text-white"
                  />
                </div>
                <div>
                  <label className="block text-[11px] text-slate-600 dark:text-slate-400 mb-1">Employment</label>
                  <select
                    value={employmentType}
                    onChange={(e) => setEmploymentType(e.target.value)}
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1 text-xs text-slate-900 dark:text-white"
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[11px] text-slate-600 dark:text-slate-400 mb-1">Monthly Income (₹)</label>
                  <input
                    type="number"
                    value={monthlyIncome}
                    onChange={(e) => setMonthlyIncome(Number(e.target.value))}
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-xs text-slate-900 dark:text-white font-mono"
                  />
                </div>
                <div>
                  <label className="block text-[11px] text-slate-600 dark:text-slate-400 mb-1">Existing EMI (₹)</label>
                  <input
                    type="number"
            ...
            <div className="p-3 bg-slate-50/80 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800 space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div>
                  <label className="block text-[10px] text-slate-600 dark:text-slate-400 mb-1">CIBIL Score</label>
                  <input
                    type="number"
                    value={cibilScore}
                    onChange={(e) => setCibilScore(Number(e.target.value))}
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1 text-xs text-slate-900 dark:text-white font-mono"
                  />
                </div>
                <div>
                  <label className="block text-[10px] text-slate-600 dark:text-slate-400 mb-1">Max DPD (12M)</label>
                  <input
                    type="number"
                    value={maxDpd12m}
                ...
                <div>
                  <label className="block text-[10px] text-slate-600 dark:text-slate-400 mb-1">Enquiries (3M)</label>
                  <input
                    type="number"
                    value={enquiries3m}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block text-[10px] text-slate-600 dark:text-slate-400 mb-1">Write-off Accounts</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-[10px] text-slate-600 dark:text-slate-400 mb-1">Avg Bank Balance (₹)</label>
                  <input
                    type="number"
            ...
            {/* Risk & Fraud Flags */}
            <div className="p-3 bg-slate-50/80 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2">
              <span className="text-[11px] font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider block">
                KYC & Fraud Checks
              </span>
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <label className="flex items-center gap-1.5 cursor-pointer text-rose-600 dark:text-rose-300">
                  <input
                    type="checkbox"
                    checked={isDuplicateApplicant}
                    onChange={(e) => setIsDuplicateApplicant(e.target.checked)}
                    className="rounded text-rose-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700"
                  />
        ...
        <div className="lg:col-span-7 space-y-4">
          {simulationResult ? (
            <div className="bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-xl space-y-5 animate-in fade-in duration-300">
              ...
              <div
                className={`p-4 rounded-xl border flex items-center justify-between gap-4 ${
                  simulationResult.decision === 'APPROVE'
                    ...
                    ? 'bg-cyan-50 dark:bg-cyan-950/40 border-cyan-300 dark:border-cyan-500/50 text-cyan-800 dark:text-cyan-300'
                    ...
                    : 'bg-rose-50 dark:bg-rose-950/40 border-rose-300 dark:border-rose-500/50 text-rose-800 dark:text-rose-300'
                }`}
              >
                ...
                <div className="text-right">
                  <div className="flex items-center gap-2 justify-end">
                    <span className="text-xs text-slate-500 dark:text-slate-400">Risk Grade:</span>
                    <span className="px-2.5 py-0.5 rounded-lg text-xs font-black bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white">
                      {simulationResult.riskGrade}
                    </span>
                  </div>
                  <span className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 block">
                    Score: <strong className="text-indigo-600 dark:text-indigo-300">{simulationResult.riskScore} / 100</strong>
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                <div className="p-3 bg-slate-50 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800">
                  <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 block mb-0.5">Calculated FOIR</span>
                  <span className={`text-base font-bold font-mono ${simulationResult.foirPct > 60 ? 'text-rose-600 dark:text-rose-400' : 'text-emerald-600 dark:text-emerald-400'}`}>
                    {simulationResult.foirPct}%
                  </span>
                </div>

                <div className="p-3 bg-slate-50 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800">
                  <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 block mb-0.5">Proposed EMI</span>
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800">
                  <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 block mb-0.5">Max Eligible Loan</span>
                  <span className="text-base font-bold font-mono text-indigo-600 dark:text-indigo-300">
                    {formatCurrency(simulationResult.eligibleAmount)}
                  </span>
                </div>

                <div className="p-3 bg-slate-50 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800">
                  <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 block mb-0.5">Recommended</span>
                  <span className="text-base font-bold font-mono text-emerald-600 dark:text-emerald-300">
              ...
              {simulationResult.conditions.length > 0 && (
                <div className="p-3.5 rounded-xl bg-cyan-50 dark:bg-cyan-950/20 border border-cyan-200 dark:border-cyan-500/30 space-y-1.5">
                  <span className="text-xs font-bold text-cyan-700 dark:text-cyan-300 uppercase tracking-wider flex items-center gap-1.5">
                    <CheckCircle2 className="w-3.5 h-3.5" />
                    Required Approval Conditions ({simulationResult.conditions.length})
                  </span>
                  <ul className="space-y-1 text-xs text-cyan-800 dark:text-cyan-200">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 text-[11px]">
                    <span className="text-emerald-600 dark:text-emerald-400">{simulationResult.passedCount} Passed</span>
                    <span className="text-slate-300 dark:text-slate-600">|</span>
                    <span className="text-rose-600 dark:text-rose-400">{simulationResult.failedCount} Failed</span>
                    <span className="text-slate-300 dark:text-slate-600">|</span>
                    <span className="text-amber-600 dark:text-amber-400">{simulationResult.referredCount} Referred</span>
                  </div>
                </div>
                    ...
                    <div
                      ...
                      className={`p-2.5 rounded-xl border text-xs ${
                        rule.passed
                          ...
                          : 'bg-rose-50/60 dark:bg-rose-950/20 border-rose-200 dark:border-rose-500/40'
                      }`}
                    >
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="font-bold text-slate-900 dark:text-white">{rule.ruleName}</span>
                          <span className="font-mono text-[10px] text-slate-500 dark:text-slate-400">({rule.ruleCode})</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 mt-1 font-mono">
                        <div>
                          Input: <strong className="text-slate-800 dark:text-slate-200">{String(rule.actualValue)}</strong>
                        </div>
                        <div>
                          Condition: <span className="text-indigo-600 dark:text-indigo-300">{rule.operator} {String(rule.expectedValue)}</span>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <div className="flex flex-col items-center justify-center p-12 bg-slate-50/50 dark:bg-slate-900/60 border border-dashed border-slate-200 dark:border-slate-800 rounded-2xl text-center text-slate-500 dark:text-slate-400 space-y-3">
              <div className="p-3 bg-indigo-50 dark:bg-indigo-500/10 rounded-2xl text-indigo-600 dark:text-indigo-400">
                <Sparkles className="w-8 h-8" />
              </div>
              <div>
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-300">Ready for Simulation</h3>
