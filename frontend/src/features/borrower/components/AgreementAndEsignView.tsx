...
export const AgreementAndEsignView: React.FC<AgreementAndEsignViewProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 shadow-xs space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-800 space-y-4 font-mono text-xs text-slate-700 dark:text-slate-300 leading-relaxed max-h-80 overflow-y-auto scrollbar-thin">
        <div className="text-center font-bold text-slate-900 dark:text-white uppercase text-sm border-b border-slate-200 dark:border-slate-800 pb-2">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          1. <strong className="text-slate-900 dark:text-slate-200">SANCTION & REPAYMENT</strong>: The Borrower agrees to repay the Principal together with Interest accrued at the reducing rate specified in the Key Fact Statement (KFS) in regular Equated Monthly Installments (EMIs).
        </p>
        <p className="text-slate-600 dark:text-slate-400">
          2. <strong className="text-slate-900 dark:text-slate-200">AUTO-DEBIT MANDATE</strong>: The Borrower authorizes the Lender to debit the designated bank account via eNACH / NPCI Mandate on each monthly due date.
        </p>
        <p className="text-slate-600 dark:text-slate-400">
          3. <strong className="text-slate-900 dark:text-slate-200">COOLING-OFF PERIOD</strong>: The Borrower is entitled to a 3-day statutory cooling-off period from the date of execution to exit the loan by repaying principal without penalty.
        </p>
        <p className="text-slate-600 dark:text-slate-400">
          4. <strong className="text-slate-900 dark:text-slate-200">STATUTORY RECOVERY CODE</strong>: The Lender strictly adheres to RBI Fair Practices Code for loan recovery and borrower communication.
        </p>
      </div>
      ...
      <div className="p-4 rounded-2xl bg-slate-50/70 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h4 className="text-sm font-bold text-slate-900 dark:text-white">Electronic Signature Verification</h4>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            {isSigned
        ...
        <div className="flex items-center gap-3">
          {!isSigned && !esignSessionId && (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs flex items-center gap-2 shadow-md shadow-blue-600/20 transition-all"
            >
