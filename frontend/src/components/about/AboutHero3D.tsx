...
export const AboutHero3D: React.FC = () => {
  const journeyFrameRef = useRef<HTMLDivElement>(null);
  ...
  const updateTilt = useCallback(() => {
    ...
    if (journeyFrameRef.current) {
      journeyFrameRef.current.style.transform = `perspective(1200px) rotateX(${g.rx.toFixed(
        2
  ...
  const handlePointerMove = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    const rect = journeyFrameRef.current.getBoundingClientRect();
  ...
  return (
    ...
    >
      {/* ── Subdued Technical Blueprint Grid Lines ── */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div className="absolute top-12 right-1/4 w-[650px] h-[550px] bg-gradient-to-bl from-blue-100/60 via-slate-50/40 to-transparent blur-[140px] rounded-full pointer-events-none" />
      ...
      {/* ── Main Editorial Split (58% Narrative / 42% The Journey Forward) ── */}
      <div className="max-w-[1400px] mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center my-auto py-8">
        {/* Left Column (58%): Editorial Value Prop */}
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          {/* Headline Line 1: BUILT FOR THE MOMENTS */}
          <div
            data-depth-z="-700"
            data-rotate-x="30"
            data-offset-y="60"
          ...
          {/* Headline Line 2: THAT MOVE PEOPLE FORWARD. */}
          <div
            data-depth-z="-1000"
            data-rotate-x="38"
            data-offset-y="90"
          ...
          >
            <p className="text-base sm:text-lg lg:text-xl text-slate-600 font-normal leading-relaxed max-w-2xl font-sans">
              Adyapan brings technology, financial infrastructure and simpler digital experiences together to help make financial journeys easier to move through.
            </p>
          </div>
          ...
          >
            <button
              type="button"
              onClick={() => scrollToSection('about-ecosystem')}
          ...
          <div className="pt-3 border-t border-slate-200/80 flex items-center gap-3 text-xs text-slate-500 font-sans">
            ...
            <span>
              Enterprise lending & core banking technology platform engineered for ambitious institutions across India.
            </span>
          </div>
        </div>

        {/* ── Right Column (42%): "THE JOURNEY FORWARD" 3D Visual ── */}
        <div
          data-depth-z="-900"
          data-rotate-x="18"
          data-rotate-y="16"
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              ...
              <div className="px-2.5 py-1 rounded-full bg-blue-50 border border-blue-200 text-[#155EEF] text-[10px] font-mono font-bold flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#155EEF] animate-pulse" />
                <span>ACTIVE</span>
              </div>
            </div>

            {/* Central Forward-Moving Pathway Graphic */}
            <div className="py-5 text-center space-y-2 border-b border-slate-100">
              ...
              <p className="text-xs font-mono font-bold text-slate-700 uppercase tracking-wider">
                FINANCIAL ADVANCEMENT IN MOTION
              </p>
            </div>

            {/* 4 Physical 3D Planes Aligning Toward Central Point */}
            <div className="py-4 space-y-2.5 font-mono text-xs">
              ...
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/70 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#071A33] text-[11px]">01. PEOPLE</span>
                </div>
                <span className="text-slate-600 font-bold text-[10px]">BORROWERS & BUILDERS</span>
              </div>
              ...
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/70 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#071A33] text-[11px]">02. PRODUCT</span>
                </div>
                <span className="text-slate-600 font-bold text-[10px]">INTUITIVE EXPERIENCES</span>
              </div>
              ...
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/70 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#071A33] text-[11px]">03. TECHNOLOGY</span>
                </div>
                <span className="text-slate-600 font-bold text-[10px]">MODULAR & RESILIENT</span>
              </div>
              ...
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/70 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#071A33] text-[11px]">04. FINANCE</span>
                </div>
                <span className="text-emerald-700 font-bold text-[10px]">RESPONSIBLE CAPITAL</span>
              </div>
            </div>

            {/* Footer */}
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-sans">
              <span className="text-[11px]">Different Pieces · One Connected Journey</span>
              <span className="text-[10px] font-mono text-slate-400">ADYAPAN CORE</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto w-full pt-6 pb-2 text-center border-t border-slate-100 flex items-center justify-between text-xs font-mono text-slate-400">
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-[#155EEF] animate-pulse" />
          <span>SCROLL DOWN TO ADVANCE THE ADYAPAN STORY</span>
        </div>
