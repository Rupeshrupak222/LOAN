...
export const FollowTheJourneySimulator: React.FC = () => {
  ...
  return (
    <section id="journey-sim" className="relative py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      {/* Section Header */}
      ...
      {/* Main Visual Arena */}
      <div className="rounded-3xl border border-slate-800 bg-[#071A33] text-white p-7 sm:p-10 max-w-4xl mx-auto text-left shadow-2xl space-y-6">
