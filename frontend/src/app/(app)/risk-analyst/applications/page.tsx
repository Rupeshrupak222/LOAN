...
export default function RiskAnalystApplicationsPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumb="Risk Analyst / Applications"
        title="Application Risk View"
        subtitle="Read-only view for inspecting loan application data, FOIR, and BRE outcomes."
      />
