      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 space-y-4 shadow-xs">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="flex justify-between py-2 border-b border-slate-100 dark:border-slate-800/60">
              ...
              <span className="font-mono text-slate-900 dark:text-white font-semibold">{borrower?.panNumberMasked || 'ABCDE****F'}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-slate-100 dark:border-slate-800/60">
              <span className="text-slate-500 dark:text-slate-400">Aadhaar Token:</span>
              <span className="font-mono text-slate-700 dark:text-slate-300">********9012 (DigiLocker)</span>
            </div>
            <div className="flex justify-between py-2">
              <span className="text-slate-500 dark:text-slate-400">Verification Timestamp:</span>
              <span className="text-slate-500 dark:text-slate-400">NSDL Direct Match</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 space-y-4 shadow-xs">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-800 text-xs space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono text-slate-700 dark:text-slate-200">••••••••28172</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500 dark:text-slate-400">IFSC Code:</span>
              <span className="font-mono text-blue-600 dark:text-blue-400 font-semibold">HDFC0001234</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500 dark:text-slate-400">Penny Drop Verification:</span>
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 space-y-4 shadow-xs">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-800 text-xs space-y-1 text-slate-700 dark:text-slate-300 leading-relaxed">
            <div className="font-bold text-slate-900 dark:text-white">Current Residential Address</div>
            <div>Flat 402, Green Meadows, MG Road</div>
            <div>Indiranagar, Bengaluru, Karnataka - 560038</div>
            <div className="text-[11px] text-slate-500 dark:text-slate-500 mt-2">Verified via DigiLocker Proof of Address</div>
          </div>
        </div>
      </div>
    </div>
