...
import { UserPlus, Shield, Building2, Search, Users } from 'lucide-react';
...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Users & Access Governance Subnav */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs">
          <div className={cn(
            ...
            <div>
              ...
              <p className={cn("text-xs mt-0.5", isDark ? "text-slate-400" : "text-slate-500")}>Initial default login password: <code>Configured in .env (SEED_STAFF_PASSWORD)</code></p>
            </div>
