...
export default function FraudInvestigatorEvidencePage() {
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumb="Fraud Investigator / Evidence"
        title="Evidence Workspace"
        subtitle="Collect and review evidence items across assigned cases."
      />
