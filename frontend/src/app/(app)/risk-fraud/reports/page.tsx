...
export default function RiskFraudReportsPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumb="Risk & Fraud / Reports"
        title="Risk & Fraud Reporting"
        subtitle="Generate reports on fraud case volumes, risk trends, and investigation SLAs."
      />
