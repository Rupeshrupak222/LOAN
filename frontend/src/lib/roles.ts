...
export const ROLE_CONFIG: Record<RoleName, RoleConfig> = {
  SUPER_ADMIN: {
    label: 'Super Admin',
    description: 'Full enterprise control, financial parameters, and governance',
    nav: [
      'dashboard',
      'customers',
      'applications',
  ...
  ADMIN: {
    label: 'System Admin',
    description: 'Operations administration and portfolio oversight',
    nav: [
      'dashboard',
      'customers',
      'applications',
  ...
  LOAN_OFFICER: {
    label: 'Loan Officer',
    description: 'Customer onboarding, KYC document collection and loan origination',
    nav: ['dashboard', 'customers', 'applications', 'loans', 'loan-products', 'emi-calculator', 'underwriting', 'disbursements', 'payments', 'collections', 'reports'],
    landing: '/dashboard',
    dashboard: 'LOAN_OFFICER',
  },
  CREDIT_ANALYST: {
    label: 'Credit Analyst',
    description: 'Credit assessment, risk calculation and eligibility engine scoring',
    nav: ['dashboard', 'applications', 'underwriting', 'customers', 'reports', 'emi-calculator', 'loans', 'loan-products'],
    landing: '/dashboard',
    dashboard: 'CREDIT_ANALYST',
  },
  UNDERWRITER: {
    label: 'Underwriter',
    description: 'Underwriting queue review, conditional sanction and approval limits',
    nav: ['dashboard', 'underwriting', 'applications', 'customers', 'loans', 'reports', 'emi-calculator', 'disbursements', 'loan-products'],
    landing: '/dashboard',
    dashboard: 'UNDERWRITER',
  },
  FINANCE_OFFICER: {
    label: 'Finance Officer',
    description: 'Pre-disbursement checks, fund release, repayments and settlements',
    nav: ['dashboard', 'disbursements', 'payments', 'loans', 'reports', 'emi-calculator', 'customers', 'applications'],
    landing: '/dashboard',
    dashboard: 'FINANCE_OFFICER',
  },
  COLLECTION_OFFICER: {
    label: 'Collection Officer',
    description: 'Delinquency tracking, DPD aging buckets, follow-up logs and PTPs',
    nav: ['dashboard', 'collections', 'payments', 'loans', 'customers', 'emi-calculator', 'reports'],
    landing: '/dashboard',
    dashboard: 'COLLECTION_OFFICER',
  },
  BRANCH_MANAGER: {
    label: 'Branch Manager',
    description: 'Branch loans, origination metrics, local staff and recovery oversight',
    nav: [
      'dashboard',
      'customers',
      'applications',
  ...
  AUDITOR: {
    label: 'Auditor',
    description: 'Read-only compliance verification, immutable ledger and audit trail',
    nav: ['dashboard', 'audit-logs', 'reports', 'loans', 'disbursements', 'payments', 'customers', 'applications', 'branches', 'users', 'settings'],
    landing: '/dashboard',
    dashboard: 'AUDITOR',
  },
  CUSTOMER: {
    label: 'Borrower',
    description: 'Borrower portal for loan account, repayments, and statements',
    nav: ['dashboard', 'loans', 'payments', 'applications', 'customers', 'emi-calculator'],
    landing: '/dashboard',
    dashboard: 'CUSTOMER',
  },
};
