...
/* ══════════════════════════════════════════════════════════════
   Adyapan Master Navigation Bar with Fintech Mega-Menu
   ─────────────────────────────────────────────────────────────
   ...
   ▸ Scroll progress bar & Floating "Go to Top" button
...
export const MotionNavbar: React.FC = () => {
  ...
  /* ── Scroll tracking for compression & Go-To-Top button ── */
        ...
        >
          ...
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {/* 1. Products (With Mega-Menu Dropdown) */}
              <div
              ...
              >
                <button
                  ...
                  className={`px-3.5 py-1.5 text-xs font-bold transition-all rounded-xl flex items-center gap-1.5 relative group cursor-pointer ${
                    productsOpen
                      ? 'text-[#155EEF] bg-[#EAF4FF]/70'
                      : 'text-[#071A33] hover:text-[#155EEF] hover:bg-[#EAF4FF]/50'
                  }`}
                >
                  <span>Products</span>
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform duration-200 ${
                      productsOpen ? 'rotate-180 text-[#155EEF]' : 'text-slate-400 group-hover:text-[#155EEF]'
                    }`}
                  />
                  {/* Underline */}
                  <span
                    className={`absolute bottom-0 left-3.5 right-3.5 h-0.5 bg-[#155EEF] origin-left transition-transform duration-300 ${
                      productsOpen ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                    }`}
                  />
                </button>
              ...
              <a
                href="#story-scene"
                className="px-3.5 py-1.5 text-xs font-bold text-[#071A33] hover:text-[#155EEF] hover:bg-[#EAF4FF]/50 transition-all rounded-xl relative group"
              >
                <span>About</span>
                <span className="absolute bottom-0 left-3.5 right-3.5 h-0.5 bg-[#155EEF] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
              </a>
